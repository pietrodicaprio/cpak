...
type SystemCmd struct {
	Action string `arg:"action" help:"Action: setup, remove, status, enforcement, set-enforcement, signatures, set-signatures, trust, set-trust, ceiling, set-ceiling, explain, trust-root-preview, trust-root-add, trust-root-remove, trust-root-status, reputation-provider-preview, reputation-provider-set, reputation-provider-clear, reputation-import, reputation-status, reputation-check, register-session or remove-session"`
